...
import method from "../../assets/images/method.png"; // replace with your actual image path

export default function MethodDevelopment () {
  const [isImageZoomed, setIsImageZoomed] = useState(false);
  const features = [
    "Log method development experiments.",
    "Record experimental conditions and outcomes.",
    "Track optimization progress across trials.",
    "Store chromatograms, calculations, and technical files.",
    "Maintain versioned development records.",
    "Centralized retrieval of historical experiments.",
    "Improved knowledge retention and collaboration.",
  ];
  return (
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
              Cerium6 supports laboratory method development by providing a 
              centralized system for documenting experiments, tracking outcomes, and maintaining 
              organized development records throughout the optimization process.
            </p>
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
             Log method development activities, record experimental conditions and observations, 
             compare outcomes across trials, and store supporting files such as chromatograms, validation data, SOP drafts, 
             calculations, and instrument outputs for future reference and retrieval.
            </p>
            {/* BUTTONS */}
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-neutral-950 shadow-2xl">
              ...
              <div className="p-3 sm:p-4 lg:p-5">
                <img
                  src={method}
                  alt="Method Development Dashboard"
              ...
              {isImageZoomed && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 cursor-pointer" onMouseLeave={() => setIsImageZoomed(false)}>
                  <img src={method} alt="Method Development Dashboard - Zoomed" className="max-h-[90vh] max-w-[90vw] object-contain rounded-lg" />
                </div>
              )}
            </div>
          </motion.div>
