...
import project from "../../assets/images/Project Tracking.png"; // replace with your actual image path

export default function ProjectTracking () {
  const [isImageZoomed, setIsImageZoomed] = useState(false);
  const features = [
    "Group samples and requests into projects.",
    "Real-time project progress tracking.",
    "Completion and status monitoring.",
    "Centralized project notes and updates.",
    "Multi-sample workflow coordination.",
    "Improved team collaboration and visibility.",
    "Historical project records and traceability."
  ];
  return (
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
              Organize laboratory activities with structured project management designed 
              for commercial analytical operations. Cerium6 allows laboratories to group
              related sample requests into projects, monitor analytical progress, track completion 
              status, and maintain centralized project records from initiation to delivery.
            </p>
            {/* BUTTONS */}
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-neutral-950 shadow-2xl">
              ...
              {isImageZoomed && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 cursor-pointer" onMouseLeave={() => setIsImageZoomed(false)}>
                  <img src={project} alt="Project Tracking Dashboard - Zoomed" className="max-h-[90vh] max-w-[90vw] object-contain rounded-lg" />
                </div>
              )}
            </div>
          </motion.div>
