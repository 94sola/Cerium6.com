...
export default function Reporting () {
  const features = [
    ...
    "Analyst proficiency reports.",
    "Method development reports.",
    "Customizable report templates.",
    "Consistent formatting and branding.",
    "Centralized report storage and retrieval.",
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
              Generate structured laboratory reports with automated PDF formatting 
              designed for commercial analytical operations. Cerium6 supports 
              multiple report categories including analysis reports, analyst competency reports, method development reports, and 
              operational documentation using customizable standardized templates.   
            </p>
            {/* BUTTONS */}
