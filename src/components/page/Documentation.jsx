...
export default function Documentation() {
  ...
  const features = [
    "Upload documents in multiple file formats.",
    "Store raw analytical data and technical records securely.",
    "Manage method documents and SOPs efficiently.",
    "Upload screenshots, chromatograms, and instrument outputs.",
    "Categorize documents by workflow or activity.",
    "Centralized document viewing and retrieval.",
    "Improved traceability and laboratory organization.",
    "Secure long-term laboratory record management.",
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
              Maintain organized, secure, and accessible laboratory records with
              a centralized document management system designed for analytical
              laboratories and regulated workflows.
            </p>

            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-gray-400 sm:text-lg lg:mx-0">
              Cerium6 enables teams to securely manage operational documents,
              analytical raw data, technical files, SOPs, and laboratory images
              while ensuring structured categorization and simplified retrieval.
            </p>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-neutral-950 shadow-2xl">
              ...
              {isImageZoomed && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 cursor-pointer" onMouseLeave={() => setIsImageZoomed(false)}>
                  <img src={document} alt="Document Management Dashboard - Zoomed" className="max-h-[90vh] max-w-[90vw] object-contain rounded-lg" />
                </div>
              )}
            </div>
          </motion.div>
        ...
        <div className="mt-24 sm:mt-28 lg:mt-32">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-4 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm font-medium text-gray-300">
