...
import sample    from "../../assets/images/Sample Management.png"; // replace with your actual image path

export default function SampleManagement () {
  const [isImageZoomed, setIsImageZoomed] = useState(false);
   const features = [
    "Sample registration and unique identification.",
    "Parameter and test assignment.",
    "Sample status and progress tracking.",
    "Analyst assignment and coordination.",
    "Turnaround time monitoring.",
    "Project-based sample organization.",
    "Improved operational visibility.",
    "Centralized sample records and traceability.",
  ];
  return (
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
              Cerium6 provides a centralized sample management system designed to help commercial analytical 
              laboratories efficiently handle samples from registration to final reporting.
            </p>

            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-300 sm:text-lg lg:mx-0">
              Log incoming samples, assign analytical parameters and responsible personnel, monitor testing 
              progress, and maintain complete traceability across laboratory operations. 
              The platform improves visibility, organization, and coordination while 
              helping laboratories manage turnaround timelines and operational efficiency more effectively.
            </p>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-neutral-950 shadow-2xl">
              ...
              <div className="p-3 sm:p-4 lg:p-5">
                <img
                  src={sample}
                  alt="Sample Management Dashboard"
              ...
              {isImageZoomed && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 cursor-pointer" onMouseLeave={() => setIsImageZoomed(false)}>
                  <img src={sample} alt="Sample Management Dashboard - Zoomed" className="max-h-[90vh] max-w-[90vw] object-contain rounded-lg" />
                </div>
              )}
            </div>
          </motion.div>
